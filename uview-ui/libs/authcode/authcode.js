// // //test
// var formdata ='4aa2XgTkFBHUOC3LCv/BpqtKE7S6mOkMkXCl8M3kX3TwGDQtCGM4aiktuEFeBmfBoz+Le8H+5td6+rS002IT+U2hLySKaGbs67alFzbcFjeIcK7Ps6xlyfnqOG3oQkUdvls4dt9bvzsha/Am/+iXtUEEp/KVUFk44zbXLK1HrByCx1PkUnijUBMj/seUBZ6lrd6xhV9kPkjjE4/VyLvVy/cSqRanmDKoQglSMiiy0Us'
//
// // let jiami = authcode(JSON.stringify(formdata),'key','jiami')
// // console.log('加密:')
// // console.log(jiami)
// let jiemi = authcode(formdata,'ak#2@12345','jiemi')
// console.log('解密:')
// console.log(JSON.parse(jiemi))
//

decodeURIComponent()

 export default function authcode(str, key, type) {
